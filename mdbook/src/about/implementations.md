...
This repository also automatically builds Bravura's OpenType font file directly from the
same sources as this specification, on every change: [download Bravura.otf](media/Bravura.otf).
